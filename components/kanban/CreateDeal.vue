...
<template>
    ...
    <div class="text-center mb-2">
        <button class="transition-all opacity-5 hover:opacity-100 hover:text-[#a252c8]"
            ...
            <Icon v-if="!isOpenForm" name="ep:circle-plus" class="fade-in-100 fade-out-0" size="35"/>
        </button>
    </div>
        <form v-if="isOpenForm" @submit="onSubmit" class="form">
            ...
            <UiInput placeholder="Сумма" v-model="price" v-bind="priceAttrs" type="number" class="input"/>
